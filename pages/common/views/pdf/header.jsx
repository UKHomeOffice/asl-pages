...
export default function Header({ store, model, licenceType, nonce, version, officialSensitive = true, licenceNumber }) {
  licenceNumber = licenceNumber || model.licenceNumber;
  return (
      ...
      <Provider store={store}>
        <header className="pdf-header">
          ...
          <p className="float-right">
            { licenceNumber &&
              <Fragment>{licenceType.toUpperCase()} number: <strong>{licenceNumber}</strong></Fragment>
            }
